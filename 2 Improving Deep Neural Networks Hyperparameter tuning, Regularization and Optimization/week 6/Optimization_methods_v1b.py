...
def random_mini_batches(X, Y, mini_batch_size = 64, seed = 0):
    ...
    if m % mini_batch_size != 0:
        ### START CODE HERE ### (approx. 2 lines)
        completed_examples = mini_batch_size * num_complete_minibatches
        remaining_examples = m - (completed_examples)
        mini_batch_X = shuffled_X[: , completed_examples : completed_examples + remaining_examples]
        mini_batch_Y = shuffled_Y[: , completed_examples : completed_examples + remaining_examples]
        ### END CODE HERE ###
        mini_batch = (mini_batch_X, mini_batch_Y)
        mini_batches.append(mini_batch)
...
def update_parameters_with_adam(parameters, grads, v, s, t, learning_rate = 0.01,
    ...
    for l in range(L):
        ...
        ### START CODE HERE ### (approx. 2 lines)
        update_w = v_corrected["dW" + str(l + 1)] / (np.sqrt(s_corrected["dW" + str(l + 1)]) + epsilon)
        update_b = v_corrected["db" + str(l + 1)] / (np.sqrt(s_corrected["db" + str(l + 1)]) + epsilon)
        parameters["W" + str(l+1)] = parameters["W" + str(l + 1)] - (learning_rate * update_w)
        parameters["b" + str(l+1)] = parameters["b" + str(l + 1)] - (learning_rate * update_b)
        ### END CODE HERE ###
